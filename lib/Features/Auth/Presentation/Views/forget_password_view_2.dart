...
class ForgetPasswordView2 extends StatelessWidget {
  const ForgetPasswordView2({super.key, required this.email, required this.isChangePass});
  ...
  Widget build(BuildContext context) {
    return Scaffold(body: ForgetPassword2ViewBodyConsumer(email: email,isChangePass:isChangePass));
  }
}
