...
import 'package:visit_syria/Features/Settings/Presentation/Views/widgets/about_app_and_privacy_policy_items_list_view.dart';

class AboutAppAndPrivacyPolicyItemsListViewBuilder extends StatelessWidget {
  const AboutAppAndPrivacyPolicyItemsListViewBuilder({
    super.key,
    required this.type,
  });
    ...
    return BlocBuilder<GetSettingsByTypeCubit, GetSettingsByTypeState>(
      builder: (context, state) {
        if (state is GetSettingsByTypeSuccess) {
          return AboutAppAndPrivacyPolicyItemsListView(
