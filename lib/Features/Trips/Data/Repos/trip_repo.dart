...
abstract class TripRepo {
  Future<Either<Failure, List<TripModel>>> getTripsByCategory(final String category);
  Future<Either<Failure, List<TripModel>>> getTripsCompany(final int companyID,final String category);
